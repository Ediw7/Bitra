  ...
  return (
    <footer className="bg-background pt-20 sm:pt-32 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 pb-20">
          ...
          <div className="md:col-span-5 lg:col-span-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-none bg-foreground flex items-center justify-center font-bold text-bitra-green text-xl tracking-tight -rotate-12">
                B
              </div>
              <span className="text-foreground font-bold text-3xl tracking-tighter uppercase">
                BITRA STUDIO
              </span>
            </div>
      ...
      <div className="w-full border-t-4 border-foreground overflow-hidden flex flex-col pt-4">
        ...
        <h1 className="text-[25vw] sm:text-[22vw] font-bold tracking-tighter leading-[0.75] text-center text-foreground uppercase -mb-[2vw]">
          BITRA.
        </h1>
      </div>
    </footer>
